...
.splash-text h1 { margin: 0 0 7px; font-size: 28px; line-height: 1.2; }
.splash-text p { margin: 0; color: var(--muted); font-size: 14px; }

.splash-loader { display: flex; gap: 8px; margin-top: 4px; }
.splash-loader span {
  width: 8px;
  height: 8px;
  border-radius: 50%;
