...
After a host opens a single-player Minecraft world to LAN, SeaLantern Connect can discover its port, create a P2P room, and generate a shareable invitation. Hosts can configure invitation refresh intervals and maximum player counts.

Players join by pasting an invitation generated by SeaLantern. A successfully used invitation is saved locally and automatically filled into the input the next time the app starts.
